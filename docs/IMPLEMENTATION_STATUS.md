...
- 2026-05-28 Invite-only authentication rollout complete: removed public signup/access-request endpoints and UI, switched login to email+password only, added admin invite management (create/list/revoke), added public invite resolve/accept flow at `/invite/:token`, and added secure bootstrap owner invite-link issuance using `ADMIN_INVITE_BOOTSTRAP_KEY`
